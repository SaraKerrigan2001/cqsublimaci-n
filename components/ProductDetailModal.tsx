...
import { Heart, Star, ShoppingCart, X, Loader2 } from "lucide-react";
...
export function ProductDetailModal({ product, isOpen, onOpenChange, onLike }: ProductDetailModalProps) {
  console.log('ProductDetailModal rendering. isOpen:', isOpen, 'product:', product?.name);
          ...
          <>
            <div className="relative h-64 w-full">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-2 right-2 text-white/70 hover:text-white z-20"
