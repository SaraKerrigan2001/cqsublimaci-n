...
export function HeroSection() {
  return (
    <section id="inicio" className="relative overflow-hidden min-h-[calc(100vh-65px)] flex items-center">
      ...
      <div className="relative w-full container mx-auto px-6 md:px-10 py-4 md:py-14">

        {/* MOBILE */}
        <div className="flex flex-col md:hidden items-center gap-4 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-xs">
          ...
          <div className="w-[180px] h-[200px] relative">
            <div className="absolute inset-0 bg-purple-500/20 blur-2xl rounded-full pointer-events-none" />
            <Mug3D />
          </div>
          <div className="flex flex-col w-full gap-2">
            <Link href="/servicios" passHref>
              <Button size="default" className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                Explorar <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
            </Link>
            <Link href="/servicios#proceso" passHref>
              <Button size="default" variant="outline" className="w-full border-gray-500 text-white hover:bg-white/10">
                Crear dise&ntilde;o
              </Button>
            </Link>
          </div>
